...
######################### INIT #############################################
    def __init__(self, root):
        self.root = root
        self.root.title("Cadastro de Usuário Assyst")
...
#--------------------------------- Dados do Usuário ------------------------------------#
        ...
        # --------------------Botão após dados do usuário (criado uma única vez) ----------------#
        self.btn_frame = Frame(self.root)
        self.botao_confirmar = Button(self.btn_frame, text="Confirmar e Iniciar",
        ...
        #------------------- Botão Cancelar ------------------------#
        self.btn_frame = Frame(self.root)
        self.botao_cancelar = Button(self.btn_frame, text="Cancelar",
                                    bootstyle="success", width=30,
                                    command=self.cancelar_operacao)
        self.botao_cancelar.pack()
        self.btn_frame.pack(fill='x', padx=30, pady=(0, 10))
